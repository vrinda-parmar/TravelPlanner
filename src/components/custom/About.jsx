...
const About = () => {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-amber-700 text-white p-8 -mb-4 ">
        <div className="flex flex-col lg:flex-row items-center max-w-5xl gap-8">
          {/* Text Section */}
          <div className="flex-1 pr-8">
            <h1 className="text-4xl font-extrabold mb-6 text-gray-700">About Us</h1>
